...
public class RecipeMain {
	...
	public RecipeDetailVO recipeDetailData(String url,int no)
    {
    	...
    	try
    	{
    		...
    		Elements poster=doc.select("div.centeredcrop img");// doc.select("").get(0)
    		/*
    		 *  <div class="view2_summary">
            <h3>�ʰ���, �ʽ��ǵ�, �������� ��̳� ���� �����</h3>
    		 */
    		Elements title=doc.select("div.view2_summary h3");
    		Elements chef=doc.select("div.profile_cont p.cont_name");
    		Elements chef_poster=doc.select("div.profile_pic img");
    		Elements chef_profile=doc.select("div.profile_cont p.cont_intro");
    		Elements content=doc.select("div.view2_summary_in");
    		Elements foodmake=doc.select("div.view_step_cont");
    		Elements info1=doc.select("span.view2_summary_info1");
    		Elements info2=doc.select("span.view2_summary_info2");
    		Elements info3=doc.select("span.view2_summary_info3");
    		...
    		System.out.println("콘텐트:"+vo.getContent());
    		System.out.println("getFoodMake:"+vo.getFoodmake());
